...
import ConfirmationCurie from './confirmationCurie';
import ModalCurieQuestions from "./ModalCurieQuestions";
...
class ModalCurieSurvey extends React.Component {
	...
	render() {
		...
		const steps = [
			{name: "Step 1: Title & Description", component: <ModalCurieQuestions state={this.state} titleChangeHandler={this.titleChangeHandler}/>},
